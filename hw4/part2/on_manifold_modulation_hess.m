...
% This function is implementing the hessian exit strategy suitable for 
% Convex obstacles (circle and elllipse)
% Input Shape: 
...
%   hessian_gamma          : 2x2 Hessian of γ(x)
...
function [D, E, M] = on_manifold_modulation_hess(ds, gradient_ds, gamma, gradient_gamma, tangent_gamma, hessian_gamma, isoline, c_gamma, epsilon)
    ...
    % Note: Using the psuedo-hessian function but plugging in original
    % gamma tangent and Hessian
    D_phi = compute_scaling_phi_pseudo(ds, gradient_ds, gamma, gradient_gamma, tangent_gamma, ...
                                        tangent_gamma, hessian_gamma, isoline,c_gamma);
