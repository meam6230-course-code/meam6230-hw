...
classdef VerticalCylinder < Shapes
   ...
   methods
       ...
       function self = VerticalCylinder(radius, position, velocity_function, rho, noisy_sigma)
           ...
           self = self@Shapes(gamma, gammaDistance, gradientGamma, param, position, velocity_function, rho, noisy_sigma)
