...
classdef Environment < handle
   ...
   methods
       ...
       function self = Environment(robotPosition, noisy_sigma)
        if nargin < 2
            noisy_sigma = 0.0;
        end
    ...
    function self = addEllipsoid(self, axes, position, rho, velocity_function)
        ...
        newEllipse = VerticalEllipsoid(axes, position, velocity_function, rho, self.noisy_sigma);
    ...
    function self = addCylinder(self, radius, position, rho, velocity_function)
        ...
        newCylinder = VerticalCylinder(radius, position, velocity_function, rho, self.noisy_sigma);
    ...
    function self = addPlane(self, normal, position, rho, velocity_function)
        ...
        newPlane = Plane(normal, position, velocity_function, rho, self.noisy_sigma);
    ...
    function self = addShape(self, gamma, gammaDistance, gradientGamma, parameters, position, velocity_function)
        ...
        newShape = Shapes(gamma, gammaDistance, gradientGamma, parameters, position, velocity_function, rho, self.noisy_sigma);
